...
![Total Score Distribution by Gender](path/to/image1.png)
...
![Violin Plots of Scores](path/to/image2.png)
...
![Demographic Distribution](path/to/image3.png)
...
![Parental Education Level and Count](path/to/image4.png)
